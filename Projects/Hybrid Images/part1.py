...
from helpers import load_image, save_image, my_imfilter, my_zero_padding, reflective_padding
...
#Reflictive padding and Zero padding
zero_padded = my_zero_padding(test_image, x_levels=25, y_levels=25)
reflective_padded = reflective_padding(test_image, x_levels=25, y_levels=25)

save_image(resultsDir + os.sep + 'zero_padded.jpg', zero_padded)
save_image(resultsDir + os.sep + 'reflective_padded.jpg', reflective_padded)
