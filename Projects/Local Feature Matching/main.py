...
def main():
    ...
    #print("#1 Interest Points = ", x1.shape[0])
    #print("#2 Interest Points = ", x2.shape[0])
    ...
    print('image1_features: ', image1_features.shape)
    print('image2_features: ', image2_features.shape)
